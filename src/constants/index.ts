export const HOUSE_OPTIONS = [
  ...
  },
  {
    ...
    label: "Phoenix",
    icon: "🔥",
    svgIcon: "/phoenix.svg", // Available in public folder
  ...
  },
  {
    ...
    label: "ThunderBird",
    icon: "⚡",
    svgIcon: "/thunderbird.svg", // Add thunderbird.svg to public folder
  ...
  },
  {
    ...
    label: "Unicorn",
    icon: "🦄",
    svgIcon: "/unicorn.svg", // Add unicorn.svg to public folder
